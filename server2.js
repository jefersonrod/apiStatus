...
if (fs.existsSync(fcol1hist)) {
    ...
    fs.writeFile(fcol1hist,b4,finished);
    setTimeout(gravaHistCol(1), 2000);    
...
if (fs.existsSync(fcol2hist)) {
    ...
    fs.writeFile(fcol2hist,b4,finished);
    setTimeout(gravaHistCol(2), 2000);    
    console.log("Criado novo arquivo de histórico vazio");
...
if (fs.existsSync(fcol3hist)) {
    ...
    fs.writeFile(fcol3hist,b4,finished);
    setTimeout(gravaHistCol(3), 2000);    
    console.log("Criado novo arquivo de histórico vazio");
...
if (fs.existsSync(fcol4hist)) {
    ...
    fs.writeFile(fcol4hist,b4,finished);
    setTimeout(gravaHistCol(4), 2000);    
    console.log("Criado novo arquivo de histórico vazio");
...
if (fs.existsSync(fcol5hist)) {
    ...
    fs.writeFile(fcol4hist,b4,finished);
    setTimeout(gravaHistCol(5), 2000);    
    console.log("Criado novo arquivo de histórico vazio");
...
function leHistCol(coluna){
    switch(coluna){
        ...
        case 5:
            ...
            break;
        default:
            console.log("Histórico não encontrado para coluna "+coluna);
    }    
}
